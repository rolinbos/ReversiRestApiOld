...
namespace ReversiRestApi.Models
{
    public class Game : IGame
    {
        ...
        {
            if (! this.ZetMogelijk(rijZet, kolomZet) && !this.ZetMogelijk(rijZet, kolomZet))
        ...
        private bool DraaiStenenVanTegenstanderInOpgegevenRichtingOmIndienIngesloten(int rijZet, int kolomZet, Kleur kleurZetter, int rijRichting, int kolomRichting)
        {
            int rij, kolom;
            Kleur kleurTegenstander = GetKleurTegenstander(kleurZetter);
